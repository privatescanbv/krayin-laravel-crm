...
<div class="flex w-full flex-col gap-4">
    ...
    <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 p-6">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center gap-3 mt-2">
                        @if($isQualified)
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div>
                <label class="flex items-center gap-2 mb-1.5 text-xs font-medium text-gray-600 dark:text-gray-400">
                    <span class="icon-document text-sm"></span>
                    <span>Soort aanvraag</span>
                </label>
                <div class="relative">
                    <input
                        type="text"
                        class="w-full px-3 py-2 rounded-lg border border-gray-300 bg-gray-50 text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 pr-8"
                        value="{{ $requestType }}"
                        readonly
                    />
                    <span class="absolute right-3 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-purple-500"></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center gap-2 mb-2">
                <div class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30">
                    <span class="icon-target text-lg text-blue-600 dark:text-blue-400"></span>
                </div>
            ...
            <div>
                <label class="flex items-center gap-2 mb-1.5 text-xs font-medium text-gray-600 dark:text-gray-400">
                    <span class="icon-target text-sm"></span>
                ...
                <div class="relative">
                    <input
                        ...
                        readonly
                    />
                    <span class="absolute right-3 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-blue-500"></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center gap-2 mb-2">
                <div class="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30">
                    <span class="icon-grid text-lg text-green-600 dark:text-green-400"></span>
                </div>
            ...
            <div>
                <label class="flex items-center gap-2 mb-1.5 text-xs font-medium text-gray-600 dark:text-gray-400">
                    <span class="icon-grid text-sm"></span>
                    <span>Campagne</span>
                </label>
                <div class="relative">
                    <input
                        ...
                        readonly
                    />
                    <span class="absolute right-3 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-green-500"></span>
                </div>
            </div>
        </div>
    </div>
