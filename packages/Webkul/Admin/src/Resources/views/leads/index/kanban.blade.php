                                    ...
                                    <div class="flex items-start justify-between gap-2">
                                       <div class="flex items-center gap-1 min-w-0 flex-1">
                                           <div class="flex flex-col gap-0.5 min-w-0">
                                               ...
                                               <span class="text-xs leading-normal" v-if="element.persons && element.persons.length > 0 && element.persons[0]?.organization?.name">
            ...
            app.component('v-leads-kanban', {
                ...
                methods: {
                    ...
                    async updateLeadStage(leadId, stageId, additionalData = {}) {
                        ...
                        this.$axios
                            .put("{{ route('admin.leads.stage.update', 'replace') }}".replace('replace',
                                leadId), data)
                            .then(response => {
                                this.$emitter.emit('add-flash', {
                                    type: 'success',
