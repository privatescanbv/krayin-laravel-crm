...
namespace Illuminate\Database\Query {
     ...
     */        class Builder {
                    /**
         * @see \class@anonymous /usr/share/nginx/html/app/Providers/AuditTrailServiceProvider.php:73$94::creator()
         * @static
         */        public static function creator()
        {
                        return \Illuminate\Database\Query\Builder::creator();
        }
                    /**
         * @see \class@anonymous /usr/share/nginx/html/app/Providers/AuditTrailServiceProvider.php:73$94::updater()
         * @static
         */        public static function updater()
        {
                        return \Illuminate\Database\Query\Builder::updater();
        }
                    /**
         * @see \class@anonymous /usr/share/nginx/html/app/Providers/AuditTrailServiceProvider.php:145$96::getFillable()
         * @static
         */        public static function getFillable()
        {
                        return \Illuminate\Database\Query\Builder::getFillable();
        }
            }
    }
