...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('partner_products', function (Blueprint $table) {
            ...
            // Remove purchase_price_royal_doctors field if it exists (skip for SQLite)
            if (config('database.default') !== 'sqlite' && Schema::hasColumn('partner_products', 'purchase_price_royal_doctors')) {
    ...
    {
        // Skip rollback for SQLite as it doesn't support dropColumn operations
