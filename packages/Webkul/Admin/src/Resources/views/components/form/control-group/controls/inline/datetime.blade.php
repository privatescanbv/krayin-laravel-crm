            ...
            >
                ...
                <div class="absolute top-1/2 flex -translate-y-1/2 transform gap-0.5 bg-white ltr:right-2 rtl:left-2">
                    <button
                        ...
                        @click="save"
                    >
                        <i class="icon-tick text-md cursor-pointer font-bold text-status-active-text" />
                    </button>
                    ...
                    <button
                        ...
                        @click="cancel"
                    >
                        <i class="icon-cross-large text-md cursor-pointer font-bold text-status-expired-text" />
                    </button>
                </div>
