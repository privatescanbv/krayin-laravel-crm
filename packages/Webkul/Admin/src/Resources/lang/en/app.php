...
return [
        ...
        'layouts' => [
            ...
            'header' => [
                'mega-search' => [
                    ...
                    'explore-all-sales'             => 'Explore all Sales',
                    ...
                    'explore-all-matching-sales'    => 'Explore all sales matching ":query" (:count)',
    ...
    'settings' => [
        ...
        'folders' => [
            'index' => [
                ...
                'delete-not-allowed'          => 'This folder cannot be deleted.',
                'mass-delete-success'         => 'Folders deleted successfully',
                'mass-delete-partial-success' => 'Some folders could not be deleted: :folders',
                'mass-delete-failed'          => 'Failed to delete folders.',
    ...
    'mail' => [
        ...
        'view' => [
            ...
            'forward-attachments-title'  => 'Attachments from original message',
            'forward-attachments-help'   => 'These attachments will be included automatically when you click Send.',
            'forward-attachments-badge'  => 'Will be forwarded',
            'discard'                    => 'Discard',
            'send'                       => 'Send',
    ...
    'leads' => [
        ...
        'view' => [
            ...
            'duplicates' => [
                ...
                'potential-duplicates'    => 'Potential Duplicates (:count)',
                'select-fields'           => 'Select leads to merge and choose which field values to keep.',
                'no-duplicates'           => 'No Duplicates Found',
                'no-duplicates-info'      => 'No potential duplicate leads were found for this lead.',
                'back-to-lead'            => 'Back to Lead',
                'merge-success'           => 'Leads merged successfully!',
                'merge-error'             => 'Error merging leads: :message',
                'merge-confirm'           => 'Are you sure you want to merge these leads? This action cannot be undone.',
                'select-one-duplicate'    => 'Please select at least one duplicate lead to merge.',
                'selected-count'          => 'Selected :count lead(s) for merging',
                'merging'                 => 'Merging...',
                'merge-selected'          => 'Merge Selected Leads',
                'cancel'                  => 'Cancel',
                'field-title'             => 'Title',
    ...
    'orders' => [
        'view' => [
            ...
            'delete-failed' => 'Failed to delete order.',
        ],
    ],
    ...
    'productgroups' => [
        ...
        'index' => [
            ...
            'create-success' => 'Product group created successfully.',
            'update-success' => 'Product group updated successfully.',
    ...
    'anamnesis' => [
        'fields' => [
            ...
            'implant_notes'              => 'Implant details',
            'surgeries'                  => 'Have you had surgeries in the past?',
            'surgeries_notes'            => 'Surgery details',
            'heart_problems'             => 'Do you have heart problems?',
            'heart_problems_notes'       => 'Heart complaint details',
            'back_problems'              => 'Can you lie still on your back for a longer time?',
            'back_problems_notes'        => 'Back complaint details',
            'allergies'                  => 'Do you have allergies?',
            'allergies_notes'            => 'Allergy details',
            'digestive_problems'         => 'Do you have digestive complaints?',
            'digestive_problems_notes'   => 'Digestive details',
            'spijsverteringsklachten'    => 'Digestive complaints',
            'digestive_complaints_notes' => 'Digestive complaint details',
            'hereditary_heart'           => 'Heart condition (hereditary)?',
            'hereditary_heart_notes'     => 'Hereditary heart details',
            'hereditary_vascular'        => 'Heart and/or vascular disease in immediate family?',
            'hereditary_vascular_notes'  => 'Hereditary vascular details',
            'hereditary_tumors'          => 'Cancer in immediate family?',
            'hereditary_tumors_notes'    => 'Hereditary tumor details',
