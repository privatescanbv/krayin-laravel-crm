...
class ResourceSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $csvData = [
            ...
            ['name' => 'Ranova-Augusta Rontgen', 'resource_type' => 'Rontgen', 'clinic' => 'Evidia - Augusta Klinik', 'department' => 'NTB', 'is_active' => true, 'allow_outside_availability' => true, 'external_id' => null],
            ['name' => 'Evidia-Other', 'resource_type' => 'Other', 'clinic' => 'Evidia - Augusta Klinik', 'department' => 'NTB', 'is_active' => true, 'allow_outside_availability' => true, 'external_id' => null],
