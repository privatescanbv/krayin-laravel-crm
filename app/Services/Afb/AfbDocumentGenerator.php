    ...
    private function buildViewData(
        ...
        return [
            ...
            'medical' => [
                ...
                'infectious_disease'       => $this->formatBoolean($anamnesis?->infectious_disease),
                'infectious_disease_notes' => $this->emptyToNull($anamnesis?->infectious_disease_notes),
                'medications'              => $this->formatBoolean($anamnesis?->medications),
                'medications_notes'        => $this->emptyToNull($anamnesis?->medications_notes),
            ],
