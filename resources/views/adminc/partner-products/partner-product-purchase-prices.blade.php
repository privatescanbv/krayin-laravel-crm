    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.partner_products.index.create.purchase_price_misc')
            </x-admin::form.control-group.label>
            ...
            <x-admin::form.control-group.control
                ...
                :label="trans('admin::app.partner_products.index.create.purchase_price_misc')"
                :placeholder="trans('admin::app.partner_products.index.create.purchase_price_misc')"
            />
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.partner_products.index.create.purchase_price_doctor')
            </x-admin::form.control-group.label>
            ...
            <x-admin::form.control-group.control
                ...
                :label="trans('admin::app.partner_products.index.create.purchase_price_doctor')"
                :placeholder="trans('admin::app.partner_products.index.create.purchase_price_doctor')"
            />
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.partner_products.index.create.purchase_price_cardiology')
            </x-admin::form.control-group.label>
            ...
            <x-admin::form.control-group.control
                ...
                :label="trans('admin::app.partner_products.index.create.purchase_price_cardiology')"
                :placeholder="trans('admin::app.partner_products.index.create.purchase_price_cardiology')"
            />
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.partner_products.index.create.purchase_price_clinic')
            </x-admin::form.control-group.label>
            ...
            <x-admin::form.control-group.control
                ...
                :label="trans('admin::app.partner_products.index.create.purchase_price_clinic')"
                :placeholder="trans('admin::app.partner_products.index.create.purchase_price_clinic')"
            />
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.partner_products.index.create.purchase_price_radiology')
            </x-admin::form.control-group.label>
            ...
            <x-admin::form.control-group.control
                ...
                :label="trans('admin::app.partner_products.index.create.purchase_price_radiology')"
                :placeholder="trans('admin::app.partner_products.index.create.purchase_price_radiology')"
            />
