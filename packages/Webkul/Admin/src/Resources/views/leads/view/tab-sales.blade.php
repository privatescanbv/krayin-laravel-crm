...
<div class="flex w-full flex-col gap-4">
    ...
    <div class="rounded-lg border bg-white p-2 dark:border-gray-800 dark:bg-gray-900">
        ...
        <x-admin::datagrid
            :src="route('admin.sales-leads.get', ['view_type' => 'table', 'lead_id' => $lead->id, 'status_bucket' => 'active'])"
            ref="salesActiveGrid"
        />
    </div>
    ...
    <details class="rounded-lg border bg-white p-2 dark:border-gray-800 dark:bg-gray-900">
        ...
        <div class="opacity-70">
            <x-admin::datagrid
                :src="route('admin.sales-leads.get', ['view_type' => 'table', 'lead_id' => $lead->id, 'status_bucket' => 'closed'])"
                ref="salesClosedGrid"
            />
        </div>
    </details>
