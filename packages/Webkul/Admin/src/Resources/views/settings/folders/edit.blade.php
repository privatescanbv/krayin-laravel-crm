            ...
            >
                ...
                <div class="p-6">
                    <div class="grid gap-6">
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.settings.folders.edit.is-deletable')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                id="is_deletable"
                                value="1"
                                :checked="old('is_deletable') !== null ? old('is_deletable') : $folder->is_deletable"
                                :label="trans('admin::app.settings.folders.edit.is-deletable')"
                            />
