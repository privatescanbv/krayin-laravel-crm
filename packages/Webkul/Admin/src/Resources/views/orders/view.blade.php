    ...
    <div class="relative flex flex-col gap-4 pt-3 max-lg:flex-wrap lg:grid"
        ...
        <div class="relative overflow-visible transition-all duration-300 ease-in-out">
            ...
            <div
                ...
                @include('admin::orders.view.right_panel', ['order' => $order, 'totalChecks' => $totalChecks, 'completedChecks' => $completedChecks])
            </div>
        </div>
                    ...
                    app.mixin({
                        ...
                        mounted() {
                            ...
                            if (window.location.hash) {
                                ...
                                // Valid sections
                                const validSections = ['algemeen', 'activiteiten', 'afletteren', 'betalingen', 'anamnese'];
