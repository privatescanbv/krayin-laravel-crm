{!! view_render_event('admin.sales-leads.index.kanban.search.before') !!}

<v-sales-leads-kanban-search
...
{!! view_render_event('admin.sales-leads.index.kanban.search.after') !!}

@pushOnce('scripts')
    <script
        type="text/x-template"
        id="v-sales-leads-kanban-search-template"
    >
    ...
    <script type="module">
        app.component('v-sales-leads-kanban-search', {
            template: '#v-sales-leads-kanban-search-template',
