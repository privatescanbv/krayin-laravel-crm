...
docker pull ghcr.io/privatescanbv/krayin-laravel-crm/krayincrm:prod &
docker pull ghcr.io/privatescanbv/krayin-laravel-crm/keycloak:prod &
docker pull ghcr.io/privatescanbv/privatecrm/suitecrm:1.0 &
docker pull ghcr.io/privatescanbv/privateforms/forms:prod &
...
docker create --name temp-crm ghcr.io/privatescanbv/krayin-laravel-crm/krayincrm:prod
