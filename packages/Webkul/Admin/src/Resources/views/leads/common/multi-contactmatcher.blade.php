            ...
            <div>
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between mb-2">
                        <span
                            class="font-semibold text-sm">Gekoppelde contactpersonen ({{ selectedPersons.length }})</span>
                        <button
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-2 mt-1 text-sm text-gray-600">
                                        <span
                                            v-if="person.emails && person.emails.length">{{ person.emails[0].value }}</span>
                                        <span
                                            v-if="person.phones && person.phones.length">{{ person.phones[0].value }}</span>

                                        <!-- Match score indicator -->
                                        <div v-if="person.match_score_percentage !== null"
                    ...
                    <div v-if="selectedPersons.length === 0"
                         class="p-3 border rounded bg-gray-50 border-gray-200 text-center text-gray-500">
                        Geen contactpersonen gekoppeld
                    </div>
                </div>

                <!-- Contact aanmaken van lead gegevens -->
                <div v-if="lead && lead.id && (lead.first_name || lead.last_name || lead.emails || lead.phones)"
                     class="mb-4 p-3 border rounded bg-yellow-50 border-yellow-200">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <div v-if="isSearching" class="absolute right-3 top-1/2 transform -translate-y-1/2 -mb-1">
                            <svg class="h-4 w-4 animate-spin text-gray-500" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div v-if="search.length >= 2 && !isSearching && suggestions.length === 0"
                         class="p-3 border rounded bg-blue-50 border-blue-200">
                        <div class="text-center">
                            <div class="text-sm text-blue-700 mb-2">Geen bestaande contactpersonen gevonden voor
                                "{{ search }}"
                            </div>
                            <button
