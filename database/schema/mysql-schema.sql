...
CREATE TABLE `anamnesis` (
  ...
  `person_id` int unsigned DEFAULT NULL,
  `gvl_form_link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` int unsigned DEFAULT NULL,
  `updated_by` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `email_templates` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'algemeen',
  `language` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'nl',
...
CREATE TABLE `leads` (
  ...
  `national_identification_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'BSN',
  PRIMARY KEY (`id`),
...
CREATE TABLE `orders` (
  ...
  `total_price` decimal(12,2) NOT NULL DEFAULT '0.00',
  `confirmation_letter_content` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
...
CREATE TABLE `persons` (
  ...
  `user_id` int unsigned DEFAULT NULL,
  `keycloak_user_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '0',
