...
Binnen het systeem worden op vaste momenten automatisch notificaties aangemaakt. Dit gebeurt bijvoorbeeld wanneer:

* een document (zoals een orderbevestiging) beschikbaar wordt gesteld;
* nieuwe informatie klaarstaat voor de patiënt in het portaal.

Deze notificaties zijn zichtbaar voor de patiënt in het patiëntenportaal, zodra de patiënt inlogt.

Daarnaast ontvangt de patiënt dagelijks om 08:00 uur een e-mail, mits er nog ongeziene notificaties klaarstaan.

Deze e-mail bevat:

* een korte melding dat er nieuwe informatie beschikbaar is;

* geen inhoudelijke medische of administratieve details;

* een link naar het patiëntenportaal om de notificaties te bekijken.

Op deze manier blijft alle inhoudelijke communicatie centraal beschikbaar in het CRM en het patiëntenportaal, terwijl patiënten toch actief worden geïnformeerd dat er nieuwe informatie voor hen klaarstaat.
