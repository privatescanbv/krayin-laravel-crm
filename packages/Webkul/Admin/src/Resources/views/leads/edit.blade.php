        ...
        >
            <div
                ...
                <div class="flex flex-col gap-4 px-4 py-2">
                    ...
                    <!-- Emails Section -->
                    @include('admin::leads.common.sections.emails', ['name' => 'emails', 'value' => ($lead->emails ?? []), 'readonly' => $lead->persons && $lead->persons->count() > 0])
                    ...
                    <!-- Phones Section -->
                    @include('admin::leads.common.sections.phones', ['name' => 'phones', 'value' => ($lead->phones ?? []), 'readonly' => $lead->persons && $lead->persons->count() > 0])
                    ...
                    >
                        <div class="w-1/2 max-md:w-full">
                            @include('admin::components.address', ['entity' => $lead, 'readonly' => $lead->persons && $lead->persons->count() > 0])
                        </div>
                    </div>
