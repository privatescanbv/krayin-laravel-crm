...
class WorkflowSeeder extends Seeder
{
    ...
    private function createActivityTitle(PipelineStage $stage): array
    {
        ...
        return match ($stage) {
            ...
            PipelineStage::SALES_ASSESSMENT_DONE_HERNIA                  => [['Beoordeling gereed', $defaultDescription, ActivityType::TASK, 0]],
            PipelineStage::SALES_PATIENT_REFLECTION_TIME_HERNIA          => [['Patiënt bedenktijd', $defaultDescription, ActivityType::TASK, 30]],
            PipelineStage::SALES_PLANNED_FOR_ADDITIONAL_RESEARCH_HERNIA  => [['Gepland voor aanvullend onderzoekGepland voor aanvullend onderzoek', $defaultDescription, ActivityType::TASK, 0]],
            PipelineStage::SALES_CONFIRM_TREATMENT_HERNIA                => [['Behandeling bevestigen', $defaultDescription, ActivityType::TASK, 0]],
            PipelineStage::SALES_DOC_COMPLETE_HERNIA                     => [['Documentatie volledig / ontvangen', $defaultDescription, ActivityType::TASK, 1]],
            PipelineStage::SALES_TREATMENT_PLANNED_HERNIA                => [['Behandeling gepland', $defaultDescription, ActivityType::TASK, 0]],
            PipelineStage::SALES_AFTER_TREATMENT_HERNIA                  => [['Na-behandeling', $defaultDescription, ActivityType::TASK, 30]],
            PipelineStage::SALES_AFTERCARE1_HERNIA                       => [['Nazorg 1', $defaultDescription, ActivityType::TASK, 5]],
            PipelineStage::SALES_AFTERCARE2_HERNIA                       => [['Nazorg 2', $defaultDescription, ActivityType::TASK, 42]],
            PipelineStage::SALES_PHYSICAL_CONSULTATION_HERNIA            => [['Fysiek consult', $defaultDescription, ActivityType::TASK, 56]],
            PipelineStage::SALES_IN_BEHANDELING                          => [],
            PipelineStage::ORDER_CONFIRM,
            PipelineStage::ORDER_VOORBEREIDEN_HERNIA                => [['Order inplannen en versturen', $defaultDescription, ActivityType::TASK, 1]],
            ...
            PipelineStage::ORDER_BEVESTIGD_HERNIA => [
                ...
                ['Artzbrief Jost ontvangen?', $defaultDescription, ActivityType::TASK, 3],
