    ...
    public function prepareColumns(): void
    {
        $this->addColumn([
            ...
            'closure'    => function ($row) {
                ...
                return $isAvailable
                    ? "<span class='icon-tick text-status-active-text text-lg' title='".e(trans('admin::app.settings.shifts.fields.available'))."'></span>"
                    : "<span class='icon-cross-large text-status-expired-text text-lg' title='".e(trans('admin::app.settings.shifts.fields.available'))."'></span>";
            },
            'escape'     => false,
        ]);
