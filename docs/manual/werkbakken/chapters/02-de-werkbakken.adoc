...
*Afdelingsfilter:* Taken worden getoond op basis van de afdeling van de gekoppelde entiteit (lead, saleslead of order), niet alleen op basis van de toegewezen groep.
