...
return [
    ...
    [
        'key'   => 'inkoop-afletteren',
        'name'  => 'Inkoop afletteren',
        'route' => [
            'admin.inkoop.clinics.upload',
            'admin.inkoop.clinics.upload.store',
            'admin.inkoop.step0',
            'admin.inkoop.update-reference-date',
            'admin.inkoop.step1',
            'admin.inkoop.save-crm-ids',
            'admin.inkoop.reset-person-crm-id',
            'admin.inkoop.step2',
            'admin.inkoop.save-product-crm-ids',
            'admin.inkoop.reset-crm-id',
            'admin.inkoop.force-received-bulk',
            'admin.inkoop.step3',
            'admin.inkoop.mark-as-processed',
            'admin.inkoop.delete',
        ],
        'sort'  => 98,
    ],
