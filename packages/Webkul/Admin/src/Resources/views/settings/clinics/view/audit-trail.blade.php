<div class="p-4">
    {!! view_render_event('admin.settings.clinics.view.audit_trail.before', ['clinic' => $clinic]) !!}
    ...
    {!! view_render_event('admin.settings.clinics.view.audit_trail.after', ['clinic' => $clinic]) !!}
</div>