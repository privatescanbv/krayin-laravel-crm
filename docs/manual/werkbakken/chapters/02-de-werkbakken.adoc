...
*Wat zit erin?*
Alle open *taken* (type: taak) voor het hele team — ongeacht aan wie ze zijn toegewezen. Dit omvat taken gekoppeld aan leads, salesleads en orders.

*Afdelingsfilter:* Taken worden getoond op basis van de *gekozen gebruikersgroep* van de activiteit (Privatescan of Herniapoli), niet op basis van de afdeling van de gekoppelde entiteit.
