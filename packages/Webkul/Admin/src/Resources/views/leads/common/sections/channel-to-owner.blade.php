        ...
        <div class="flex-1">
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    ...
                    {!! $useVueModel ? 'v-model="formData.lead_channel_id"' : '' !!}
        ...
        <div class="flex-1">
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    type="select"
                    name="lead_source_id"
                    {!! $useVueModel ? 'v-model="formData.lead_source_id"' : '' !!}
        ...
        <div class="flex-1">
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    type="select"
                    name="department_id"
                    {!! $useVueModel ? 'v-model="formData.department_id"' : '' !!}
                    rules="required"
        ...
        <div class="flex-1">
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    type="select"
                    name="lead_type_id"
                    {!! $useVueModel ? 'v-model="formData.lead_type_id"' : '' !!}
        ...
        <div class="flex-1">
            ...
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    type="select"
                    name="mri_status"
                    {!! $useVueModel ? 'v-model="formData.mri_status"' : '' !!}
                    value="{{ $currentMRI }}"
                >
        ...
        <div class="flex-1">
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    type="select"
                    name="combine_order"
                    {!! $useVueModel ? 'v-model="formData.combine_order"' : '' !!}
