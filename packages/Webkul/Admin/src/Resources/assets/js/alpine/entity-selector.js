// Standalone initializer (no Alpine dependency)
export default function initEntitySelectorModule() {
    initEntitySelectors();
}

// Auto-initialize on DOM ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => initEntitySelectors());
} else {
    initEntitySelectors();
}
