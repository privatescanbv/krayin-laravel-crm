...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Send your API key in the <code>X-API-KEY</code> header (or authenticate with a Keycloak <code>Authorization: Bearer &lt;token&gt;</code> token).',
    ],
