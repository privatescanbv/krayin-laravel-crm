<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <div class="flex items-center gap-x-2.5">
                @if (bouncer()->hasPermission('settings.automation.campaigns.create'))
                    <a href="{{ route('admin.settings.marketing.campaigns.create') }}" class="primary-button">
        ...
        <x-admin::datagrid :src="route('admin.settings.marketing.campaigns.index')" ref="datagrid" />
    </div>
</x-admin::layouts>
