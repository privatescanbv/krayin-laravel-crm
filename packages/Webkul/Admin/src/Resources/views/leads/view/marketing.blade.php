        ...
        <div class="flex flex-col gap-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input
                        type="text"
                        class="w-full px-3 py-2 rounded-lg border bg-neutral-100 text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 pr-8"
                        value="{{ $requestType }}"
                        readonly
                    />
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center gap-2 mb-2">
                <div class="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30">
                    <span class="icon-grid text-lg text-succes dark:text-green-400"></span>
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input
                        ...
                        readonly
                    />
                    <span class="absolute right-3 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-succes"></span>
                </div>
            </div>
        </div>
    </div>
