...
@pushOnce('scripts')
    ...
    >
        ...
        <!-- Total Sales Section -->
        <template v-else>
            <div class="w-full rounded-lg border bg-white dark:border-gray-800 dark:bg-gray-900">
                ...
                >
                    <a
                        :href="`{{ route('admin.contacts.persons.view', ['id' => '__ID__']) }}`.replace('__ID__', item.id)"
