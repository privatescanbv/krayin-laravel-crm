...
class LeadResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'mri_status_label'     => match ($this->mri_status) {
                'None'          => __('Geen MRI-scan'),
                'HasRecent'     => __('Heeft recente MRI (aangegeven in diagnose formulier)'),
                'WantsViaUs'    => __('Wenst MRI via ons'),
                'GetsViaUs'     => __('Krijgt een MRI via ons'),
                'SendsExternal' => __('Stuurt extern gemaakte MRI op naar ons'),
                'Received'      => __('MRI beelden zijn binnen'),
                default         => null,
            },
