<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.settings.resource_types.update', $resourceType->id)" method="POST">
        @method('PUT')
            ...
            <div class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        type="textarea"
                        name="description"
                        >{{ old('description', $resourceType->description) }}</x-admin::form.control-group.control>
